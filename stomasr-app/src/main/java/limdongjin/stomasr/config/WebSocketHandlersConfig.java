 ...
 */
//
//import limdongjin.stomasr.handler.WebSocketSubscribeHandler;
...
//
//    @Bean
//    public WebSocketSubscribeHandler<S> webSocketSubscribeHandler(SimpMessagingTemplate messageTemplate) {
//        return new WebSocketSubscribeHandler<>(messageTemplate);
//    }
////    @Bean
